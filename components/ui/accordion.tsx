...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between gap-4 py-5 text-left text-[15px] font-semibold transition-all hover:text-primary-700 [&[data-state=open]>svg]:rotate-180",
        className
      )}
      {...props}
    >
